...
[![GoDoc](https://godoc.org/github.com/nvthongswansea/colly?status.svg)](https://godoc.org/github.com/nvthongswansea/colly)
...
[![view examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/nvthongswansea/colly/tree/master/_examples)
...
See [examples folder](https://github.com/nvthongswansea/colly/tree/master/_examples) for more detailed examples.


## Installation

```
go get -u github.com/nvthongswansea/colly/...
```


## Bugs

Bugs or suggestions? Visit the [issue tracker](https://github.com/nvthongswansea/colly/issues) or join `#colly` on freenode
...
<a href="https://github.com/nvthongswansea/colly/graphs/contributors"><img src="https://opencollective.com/colly/contributors.svg?width=890" /></a>
